public class Griffindor extends Hogwarts {
    ...
    private int ability() { // Сравнение доступно только с участниками Гриффиндор так как приватный
    ...
    public void compareGriffindor(Griffindor griffindor) {
        ...
        if (ability1 > ability2) {
            ...
            System.out.printf("Гриффиндорец %s лучше, чем гриффиндорец %s: %d VS %d%n", griffindor.getName(), getName(), ability2, ability1);
        } else {
