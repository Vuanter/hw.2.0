public class Hogwarts {
    ...
    public void print() { // Наследуется во все классы так как является публичным и принимает с других классов так как является предком
        System.out.println(this);
    }

    public void compareHogwarts(Hogwarts hogwarts) { // Наследуется во все классы так как является публичным и принимает с других классов так как является предком
